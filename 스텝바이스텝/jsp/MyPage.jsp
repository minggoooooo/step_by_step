...
<%
	...
	pageContext.setAttribute("crew", crew);
														...
														<c:choose>
															<c:when test="${crew}">
																<tr>
																	...
																	<td class="txt-C">${crew.name}</td>
																</tr>
																<tr>
																	<td class="txt-H">크루 일정</td>
																	<td class="txt-C">${crew.gatherDate}</td>
																</tr>
																<tr>
																	<td class="txt-H">목표 코스</td>
																	<td class="txt-C">${crew.courseId}</td>
																</tr>
															</c:when>
															<c:otherwise>
																<tr>
																	<td class="txt-H">예정된 일정이 없습니다</td>
																</tr>
															</c:otherwise>
														</c:choose>
													</table>
